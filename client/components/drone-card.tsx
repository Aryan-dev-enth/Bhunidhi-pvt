...
const mapCenter: [number, number] = [28.918521, 77.130035];
  const mapMarkers = [
    { position: [28.918521, 77.130035], popupContent: "Marker 1: Main Location" },
    { position: [28.928521, 77.140035], popupContent: "Marker 2: Nearby Point" },
  ];
  return (
    <motion.div
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm ${drone.status === 'Busy' ? 'text-destructive' : 'text-success'}`}>
                • {drone.status}
              </span>
            </div>
            {drone.currentSurvey && (
